...
public class இயக்கு implements JMC {
    ...
    static String கீர்த்தனை1 = "  {\n" +
            ...
            "  \t\t\"தலைப்பு\" : \"பல்லவி\",\n" +
            "  \t\t\"வரிகள்\" :[ \n" +
            "  \t\t\t\t{ \"சுரம்\" : \"சா\" , \"வார்த்தை\" : \"அம்\", \t\t\"சுரவளவு\" : \"மேல்\",   \t\"சுரகாலளவு\" : 2, \t\"x`\" : \"1/2\"},\n" +
            ...
            "  \t\t\t\t{ \"சுரம்\" : \"3\"  , \"வார்த்தை\" : \".\",   \t\"சுரவளவு\" : \"மேல்\",    \t\"சுரகாலளவு\" : 1,   \t\"அக்சரகாலம்\" : \"1/4\"},\n" +
...
*/
        ...
        பாணி = new பாணி.துருவம்(இயேரி.தமிழிசை.பாணி.லகு.I3);
    ...
    private static Phrase இசைகருவிஎண்ணியல்இடைமுகம்(பாணி பண்) {
        Phrase phrase = new Phrase();

        System.out.println("பண்.நடையைபெறு()=" + பண்.நடையைபெறு());
        System.out.println("பண்.சைகைபெறு()=" + பண்.சைகைபெறு());
        System.out.println("பண்.நடைகளைபெறு()=" + பண்.நடைகளைபெறு());
    ...
    private static Phrase இசைகருவிஎண்ணியல்இடைமுகம்(கீர்த்தனை கீர்த்தனைமாறி) {
                ...
                வரி.setசுரங்கள்(சுரப்பட்டியல்);
                        சுரப்பட்டியல்.forEach(எழுத்து -> {
                            if (எழுத்து instanceof குறியீடு) {
                                ...
                                //அச்சு("###1 வரி" + வரி  + ", கடைசிவரி=" + கடைசிவரி);
                                ...
                                //அச்சு("###2 வரி" + வரி  + ", கடைசிவரி=" + கடைசிவரி);
                            } else {
